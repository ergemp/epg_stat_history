-- DROP FUNCTION epg_stats.get_statio_all_tables_hist(int8, interval);

CREATE OR REPLACE FUNCTION epg_stats.get_statio_all_tables_hist(g_ts bigint, g_interval interval)
