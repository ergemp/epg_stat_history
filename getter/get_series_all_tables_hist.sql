...
declare 
  ...
  row_data RECORD;
begin
	CREATE TEMP TABLE IF NOT EXISTS temp_results_get_series_all_tables_hist (
		begin_ts bigint, 
    	end_ts bigint, 
		relid oid, 
  ...
  open c1 for
    ...
    LOOP
      ...
      insert into temp_results_get_series_all_tables_hist
	...
	return query
	select * from temp_results_get_series_all_tables_hist;
	
	DROP TABLE IF EXISTS temp_results_get_series_all_tables_hist;
end;
$function$
;
